...
public class UriNell {
    ...
    public static final String		PROPERTY_HAS_WIKIPEDIA_PAGE	      = NAMESPACE_PREFIX + NAMESPACE_END_ONTOLOGY + "haswikipediaurl";
	...
	final String subjectString = subject.split(":", 2)[1];
	final String objectString = object.split(":", 2)[0].equals("concept") ? object.split(":", 2)[1] : String.valueOf(object.hashCode());
